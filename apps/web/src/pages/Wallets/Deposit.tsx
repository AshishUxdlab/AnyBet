...
import { ArrowLeft, MoreVertical, PlusCircle, ShieldCheck, ArrowDownLeft, CreditCard, Clock, CheckCircle2 } from "lucide-react"
                                ...
                                <Card className="w-full border-border/60 shadow-sm overflow-hidden">
                                    <CardContent className=" space-y-4">
                                        ...
                                        <div className="space-y-2.5 pt-3 border-t border-border/40 text-xs">
                                            ...
                                            <div className="flex justify-between items-center py-1 border-t border-border/30">
                                                <span className="text-muted-foreground flex items-center gap-1.5">
                                                    <PlusCircle className="h-4 w-4" /> Fees
                                                </span>
                                ...
                                <Card className="w-full bg-primary/5 border-primary/20 p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-xs text-muted-foreground leading-relaxed">
                                            Your deposit is processed securely. Funds will be available in your balance immediately upon confirmation.
                                        </p>
                                    </div>
                                </Card>
                            </div>
                                ...
                                >
                                    {deposited ? (
                                        <span className="flex items-center gap-2">
                                            <CheckCircle2 className="h-5 w-5" /> Deposited Successfully!
                                        </span>
                                    ) : (
                                        <span className="flex items-center justify-center gap-2">
                                            Confirm & Deposit <ArrowDownLeft className="h-5 w-5" />
                                        </span>
                                    )}
                                </Button>
